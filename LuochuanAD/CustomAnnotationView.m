...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    if (selected)
    {
        if (self.calloutView == nil)
        {
            ...
            [btn setTitle:@"mu5203" forState:UIControlStateNormal];
...
- (id)initWithAnnotation:(id<MAAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        self.portraitImageView = [[UIImageView alloc] initWithFrame:CGRectMake(kHoriMargin, kVertMargin, kPortraitWidth/3*2, kPortraitHeight/3*2)];
